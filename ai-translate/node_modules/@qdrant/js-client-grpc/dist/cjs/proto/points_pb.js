...
class HardwareUsage extends protobuf_1.Message {
    constructor(data) {
         ...
         */
        this.ioRead = protobuf_1.protoInt64.zero;
        /**
         * @generated from field: uint64 io_write = 3;
         */
        this.ioWrite = protobuf_1.protoInt64.zero;
        protobuf_1.proto3.util.initPartial(data, this);
    }
    static fromBinary(bytes, options) {
